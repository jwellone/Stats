	...
	public class Stats : MonoBehaviour
	{
		...
		void Update()
		{
			...
			if (isStatistics)
			{
				...
				var batchesSavedByStaticBatching = _prDynamicBathcedDrawCallsCount.LastValue - _prDynamicBatchesCount.LastValue;
				var batchesSavedByInstancing = _prDynamicBathcedDrawCallsCount.LastValue - _prDynamicBatchesCount.LastValue;
